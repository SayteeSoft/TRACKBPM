        ...
        <main className="container mx-auto px-4 py-8">
            <Card className="max-w-3xl mx-auto">
                ...
                <CardContent className="space-y-6 text-muted-foreground">
                    ...
                    <div className="space-y-2">
                        <h2 className="text-2xl font-semibold text-foreground">"AS IS" and "AS AVAILABLE" Disclaimer</h2>
                    ...
                    <div className="space-y-2">
                        <h2 className="text-2xl font-semibold text-foreground">Changes to These Terms and Conditions</h2>
