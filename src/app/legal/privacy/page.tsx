                ...
                <CardContent className="space-y-6 text-muted-foreground">
                    ...
                    <div className="space-y-2">
                        ...
                        <ul className="list-disc pl-6 space-y-2">
                            ...
                            <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to TRACK⚡BPM.</li>
                            ...
                            <li><strong>Website</strong> refers to TRACK⚡BPM, accessible from the current domain.</li>
